        ...
        public static bool Elevate()
        {
            ...
            if (!IsRunAsAdmin())
            {
                ...
                ProcessStartInfo proc = new ProcessStartInfo
                {
                    ...
                    FileName = AppDomain.CurrentDomain.BaseDirectory + "\\DCS Configuration Manger.exe",  //Application.ExecutablePath;
                    Verb = "runas"
                };
                ...
                Process.GetCurrentProcess().Kill();  // Quit itself
            }
            else
            {
                System.Windows.MessageBox.Show("The process is running as administrator", "UAC");
                return true;
            }
            return false;
        }
